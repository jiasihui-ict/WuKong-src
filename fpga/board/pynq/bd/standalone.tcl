...
proc create_hier_cell_rv_system { parentCell nameHier } {
  ...
  #connect_bd_intf_net -intf_net axi_protocol_convert_0_M_AXI [get_bd_intf_pins WuKong_0/io_frontend] [get_bd_intf_pins axi_protocol_convert_0/M_AXI]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.PCW_DDR_RAM_BASEADDR {0x00100000}  \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#ENET Reset#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}  \
 ...
 # connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins rv_system/io_frontend]
  ...
  connect_bd_net -net processing_system7_0_IRQ_P2F_UART1 [get_bd_pins processing_system7_0/IRQ_P2F_UART1] [get_bd_pins xlconcat_0/In1]
  ...
  #create_bd_addr_seg -range 0x20000000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rv_system/WuKong_0/io_frontend/reg0] SEG_WuKong_0_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xE000B000 [get_bd_addr_spaces rv_system/WuKong_0/io_mmio] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_ENET0] SEG_processing_system7_0_GP0_ENET0
  create_bd_addr_seg -range 0x00010000 -offset 0xF8000000 [get_bd_addr_spaces rv_system/WuKong_0/io_mmio] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_PS_SLCR_REGS] SEG_processing_system7_0_GP0_PS_SLCR_REGS
  create_bd_addr_seg -range 0x00001000 -offset 0xE0100000 [get_bd_addr_spaces rv_system/WuKong_0/io_mmio] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_SDIO0] SEG_processing_system7_0_GP0_SDIO0
  create_bd_addr_seg -range 0x00001000 -offset 0xE0001000 [get_bd_addr_spaces rv_system/WuKong_0/io_mmio] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_UART1] SEG_processing_system7_0_GP0_UART1
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces rv_system/WuKong_0/io_master] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
