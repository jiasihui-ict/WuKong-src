...
object RV32I_ALUInstr extends HasInstrType with HasCoreParameter {
...
object RV32I_BRUInstr extends HasInstrType {
  ...
  val bruFuncTobtbTypeTable = List(
    ...
    ALUOpType.call -> BTBtype.C,
    ALUOpType.ret  -> BTBtype.R,
    ALUOpType.jal  -> BTBtype.J,
    ALUOpType.jalr -> BTBtype.J
  )
}
...
object RVIInstr extends HasCoreParameter {
